...
global $xoTheme;
		$xoTheme->addStylesheet(XOOPS_URL.'/modules/fbconnect/css/style.css');
	...
	$html .= "Welcome to xoops facebook connect";
	$html .= "</div>";
...
function render_footer() {
	global $onload_js;
	$html = "<div class='footer'> <a href='http://www.fluidfusion.net'>Fluidfusion</a></div>";
	$html .= "</div>";
